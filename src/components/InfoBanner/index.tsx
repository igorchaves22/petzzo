        ...
        >
            <section className="w-full h-min flex flex-col">
                {renderElement(
                    ...
                    <h2
                        className={
                            "w-full h-min text-amber-400 font-bold text-base font-quicksand" +
                ...
                <h1
                    className={
                        "w-full h-min font-bold text-4xl font-quicksand" +
                ...
                {renderElement(
                    ...
                    <p
                        className={
                            "w-full h-min font-medium text-base font-quicksand" +
            ...
            {renderElement(
                ...
                <section
                    className={
                        ...
                        applyClassName(alignLeftOnLargeScreen === "2xl", "2xl:justify-start")
                    }
                >
                    {additionalInfo}
                </section>
